...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, strict treasury-action request assembly, local adapter/OApp lifecycle, fixture-tested GenLayerJS finality, signer quorum, destination submission, acknowledged at-least-once event ingestion, durable SQLite listener/job/request-binding recovery, supervised runtime composition and read-only live packet inspector complete; approved GenLayer account-provider construction, real ULN302 and GenLayer Studio/direct-mode tests remain.
