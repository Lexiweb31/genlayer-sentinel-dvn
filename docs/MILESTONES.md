...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, local adapter EVM tests, EndpointV2-compatible OApp lifecycle and fixture-tested GenLayerJS finality adapter complete; real ULN302 and GenLayer Studio/direct-mode tests remain.
