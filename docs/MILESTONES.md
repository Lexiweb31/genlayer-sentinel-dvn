...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, local adapter/OApp lifecycle, fixture-tested GenLayerJS finality, domain-exact isolated signer quorum and idempotent destination submission complete; real ULN302 and GenLayer Studio/direct-mode tests remain.
