...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, local adapter/OApp lifecycle, fixture-tested GenLayerJS finality, signer quorum, destination submission, event ingestion, SQLite job recovery and live dashboard complete; durable listener cursor, real ULN302 and GenLayer Studio/direct-mode tests remain.
