...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, local adapter/OApp lifecycle, fixture-tested GenLayerJS finality, isolated signer quorum, destination submission, reorg-aware event ingestion and live-status dashboard complete; durable storage, real ULN302 and GenLayer Studio/direct-mode tests remain.
