...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, strict treasury-action request assembly, local adapter/OApp lifecycle, fixture-tested GenLayerJS finality, authenticated/replay-resistant remote signer protocol, signer quorum, crash-safe destination outbox with independent receipt/event confirmation, acknowledged at-least-once event ingestion, durable SQLite recovery, supervised runtime composition, read-only packet/quarantine/delivery inspector, and a 2026-07-22 official contract-metadata/finality-interface audit complete; approved GenLayer and destination account-provider construction, production mutual TLS, real five-operator signers, live directional ULN302 validation and GenLayer Studio/direct-mode tests remain.
