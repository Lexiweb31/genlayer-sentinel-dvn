...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, local adapter/OApp lifecycle, fixture-tested GenLayerJS finality, signer quorum, destination submission, event ingestion, durable SQLite listener/job recovery and read-only live packet inspector complete; atomic listener-to-job handoff, real ULN302 and GenLayer Studio/direct-mode tests remain.
