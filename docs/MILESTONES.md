...
- M1 (in progress): pinned LayerZero compilation, canonical PacketV1 verification, local adapter EVM tests and EndpointV2-compatible OApp lifecycle complete; real ULN302 and GenLayer Studio/direct-mode tests remain.
